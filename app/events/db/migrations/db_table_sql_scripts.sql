...
(
    ...
    created_at             TIMESTAMP DEFAULT timezone('utc'::text, now()),
    updated_at             TIMESTAMP DEFAULT timezone('utc'::text, now()),
    CONSTRAINT             unique_profiles_search_export_data UNIQUE (profiles_search_export_request_id, platform_username)
);
...
(
    ...
    work_platform_name                    VARCHAR(255),
    work_platform_logo_url                VARCHAR(255),
    follower_count_min                    INTEGER,
    follower_count_max                    INTEGER,
    subscriber_count_min                  INTEGER,
    subscriber_count_max                  INTEGER,
    content_count_min                     INTEGER,
    content_count_max                     INTEGER,
    audience_gender_type                  VARCHAR(50),
    audience_gender_operator              VARCHAR(50),
    audience_gender_percentage_value      FLOAT,
    creator_gender                        VARCHAR(50),
    ...
    audience_brand_affinities             JSONB,
    creator_brand_affinities              JSONB,
    average_likes_min                     INTEGER,
    average_likes_max                     INTEGER,
    average_views_min                     INTEGER,
    average_views_max                     INTEGER,
    engagement_rate_percentage_value      FLOAT,
    has_sponsored_posts                   BOOLEAN,
    brand_sponsors                        JSONB,
    instagram_options_reel_views_min      INTEGER,
    instagram_options_reel_views_max      INTEGER,
    audience_locations                    JSONB,
    creator_locations                     JSONB,
    follower_growth_interval              INTEGER,
    follower_growth_interval_unit         VARCHAR(50),
    follower_growth_operator              VARCHAR(50),
    follower_growth_percentage_value      FLOAT,
    subscriber_growth_interval            INTEGER,
    ...
    audience_location_operator            VARCHAR(50),
    sort_by_field                         VARCHAR(50),
    sort_by_order                         VARCHAR(50),
    max_results                           INTEGER,
    audience_ethnicity_type               VARCHAR(50),
    audience_ethnicity_operator           VARCHAR(50),
    audience_ethnicity_percentage_value   FLOAT,
    views_growth_interval                 INTEGER,
    views_growth_interval_unit            VARCHAR(50),
    views_growth_operator                 VARCHAR(50),
    views_growth_percentage_value         FLOAT,
    audience_source                       VARCHAR(50),
    total_engagements_min                 INTEGER,
    total_engagements_max                 INTEGER,
    audience_credibility_category         JSONB,
    created_at                            TIMESTAMP DEFAULT timezone('utc'::text, now()),
    updated_at                            TIMESTAMP DEFAULT timezone('utc'::text, now()),
