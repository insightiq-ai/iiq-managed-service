...
(
    ...
    platform_account_type                  VARCHAR(50),
    creator_account_type                   JSONB,
    audience_ethnicity                     JSONB,
    views_growth                           JSONB,
    audience_source                        VARCHAR(50),
    audience_credibility_score             FLOAT,
