...
@retry(attempts=3, delay=1, retry_exceptions=(TooManyRequestException,))
async def fetch_dictionary_userhandles(params: Optional[Dict]) -> Dict:
...
@retry(attempts=3, delay=1, retry_exceptions=(TooManyRequestException,))
async def fetch_dictionary_brands(params: Optional[Dict]) -> Dict:

    url = urllib.parse.urljoin(get_base_url(), "/v1/social/creators/dictionary/brands")
...
@retry(attempts=3, delay=1, retry_exceptions=(TooManyRequestException,))
async def fetch_dictionary_locations(params: Optional[Dict]) -> Dict:

    url = urllib.parse.urljoin(get_base_url(), "/v1/social/creators/dictionary/locations")
...
@retry(attempts=3, delay=1, retry_exceptions=(TooManyRequestException,))
async def post_audience_overlap_request(request_body: object, params: Optional[Dict]) -> Dict:
...
@retry(attempts=3, delay=1, retry_exceptions=(TooManyRequestException,))
async def post_profiles_search_export_request(request_body: object, params: Optional[Dict]) -> Dict:

    url = urllib.parse.urljoin(get_base_url(), "/v1/social/creators/profiles/search-export")
