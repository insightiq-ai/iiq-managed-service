...
class WebhookEvent(str, Enum):
    ...
    CONTENT_COMMENTS_ADDED = 'CONTENT_COMMENTS.ADDED'
    CONTENT_COMMENTS_UPDATED = 'CONTENT_COMMENTS.UPDATED'
...
product_webhook_event_mapping = {
    ...
    Product.ENGAGEMENT_AUDIENCE: {WebhookEvent.CONTENT_COMMENTS_ADDED, WebhookEvent.CONTENT_COMMENTS_UPDATED},
